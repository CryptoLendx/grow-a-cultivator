...
- **Efek saat `awr = false`** (default V0 awal game): bias sifat & tujuan di §5.2 berjalan seperti biasa TANPA komponen pembanding stat; noise §5.2 tetap ±10 (tidak berubah) — hero bertindak murni dari dorongan internal, konsisten kanon awal game (ch.7–14) sebelum riset dibuka.
...
Nilai awal saat summon: **50** (netral, TERBUKA; LAPORAN 2026-09-25 Q4). Naik: gift cocok +8 (saat `st < 70`); tuntutan mogok diterima +10; request dikabulkan +4; kesejahteraan (Restaurant + Bathhouse) +0,3/hari; cheering +2; master menghadiri ritual duka +5. Turun: gift dibenci −12 ("greatly disappointed" −20 bila `H < 40`); request ditolak −3; sintesis disaksikan −6; hukuman −15; luka moral −10; lantai 1 tanpa fasilitas −0,3/hari. [K]/[N] ch.51–301, 157, 48. **Tidak ditumpuk dengan §3.4** (pemilik 26 Sep 20:15, J12): hero dengan a ≥ 8 ke korban sintesis mendapat like −15 (§3.4 a) **menggantikan** −6; hero yang luka moralnya diakui mendapat +15/+8 (§3.4 pengakuan) **menggantikan** +10 tuntutan mogok; "luka moral −10" di atas = pemicu (c) saja (pemicu b & d tanpa Δlike). Dipakai di §6.3 (refusal) & §6.9 (request). Bentuk hubungan hero–master kanon: konflik → negosiasi → simbol → kemitraan (BK-1 §B Han↔Amkena).
